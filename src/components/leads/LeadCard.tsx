...
const isOverdue =
    ...
    return (
        ...
        >
            {/* Header — name left, score + menu right */}
            ...
            {(ageConf || isOverdue || lead.unclaimedListing) && (
                <div className="flex items-center gap-1.5 flex-wrap">
                    {ageConf && (
                        <span className={`inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full ${ageConf.color} bg-current/10`}>
