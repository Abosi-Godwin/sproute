...
import { MapPin, Phone, Globe, Star, Trash2, MoreVertical, CheckSquare, MapPinned } from "lucide-react";
                ...
                {confirmDelete ? (
                    <div className="flex items-center gap-1 flex-1">
                        ...
                        <button
                            ...
                            className="text-xs font-medium px-2 py-1.5 rounded-lg bg-red-500/10 text-red-400 hover:bg-red-500/20 transition-colors"
                        >
                            Yes
                        </button>
                        <button
                            onClick={() => setConfirmDelete(false)}
                            className="text-xs font-medium px-2 py-1.5 rounded-lg bg-base-800 text-base-400 hover:text-base-100 transition-colors"
                        >
                            No
                        </button>
                    </div>
