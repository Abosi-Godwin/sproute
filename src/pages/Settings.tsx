        ...
        <div className="p-6 space-y-6 max-w-xl pb-24">
            ...
            <div className="bg-base-900 border border-base-800 rounded-xl p-5 space-y-3">
                ...
                <p className="text-sm text-base-500">
                    A personal lead prospecting tool for finding local
                    businesses, tracking outreach and generating WhatsApp
                    messages with AI.
                </p>
                <div className="border-t border-base-800 pt-3 space-y-1">
                    {[
                        ...
                        <div
                            key={feature}
                            className="flex items-center gap-2 text-xs text-base-500"
                        >
                ...
                <p className="text-xs text-base-600">
                    v0.0.1 — Built with love for the local freelancers
                </p>
            </div>
