...
<input
    ...
    className="w-full bg-base-900 border border-base-800 rounded-lg px-4 py-2.5 text-sm text-base-100 placeholder:text-base-500 focus:outline-none focus:border-brand-500 transition-colors"
/>
            {selected.length > 0 && (
...
export default function Leads() {
    ...
    }, [leads, search, selectedStatus, noWebsiteOnly, hasPhoneOnly]);
